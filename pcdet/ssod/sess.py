...
import numpy as np
from tools.train_utils.semi_utils import transform_aug, load_data_to_gpu, filter_boxes
...
def sess(teacher_model, student_model,
    ...
    ld_teacher_boxes = transform_aug(ld_teacher_boxes, ld_teacher_batch_dict, ld_student_batch_dict)
    ud_teacher_boxes = transform_aug(ud_teacher_boxes, ud_teacher_batch_dict, ud_student_batch_dict)
