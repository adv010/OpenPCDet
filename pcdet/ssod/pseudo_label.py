import torch
from tools.train_utils.semi_utils import transform_aug, load_data_to_gpu, construct_pseudo_label
...
def pseudo_label(teacher_model, student_model,
    ...
    teacher_boxes = transform_aug(teacher_boxes, ud_teacher_batch_dict, ud_student_batch_dict)
