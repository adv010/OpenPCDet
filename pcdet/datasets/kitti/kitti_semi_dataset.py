...
class KittiLabeledDataset(KittiSemiDataset):
    ...
    def __getitem__(self, index):
        input_dict, img_shape = self.pre_getitem(index)
        teacher_dict, student_dict = self.prepare_data_ssl(input_dict, prepare_for=self.labeled_data_for, road_plane=input_dict['road_plane'])
...
class KittiUnlabeledDataset(KittiSemiDataset):
    ...
    def __getitem__(self, index):
        ...
        teacher_dict, student_dict = self.prepare_data_ssl(input_dict, prepare_for=self.unlabeled_data_for, road_plane = road_plane)
