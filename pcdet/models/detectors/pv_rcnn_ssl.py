...
class PVRCNN_SSL(Detector3DTemplate):
    ...
    def forward(self, batch_dict):
        if self.training:
            ...
            loss_rcnn_cls, loss_rcnn_box, ulb_loss_cls_dist, tb_dict = self.pv_rcnn.roi_head.get_loss(tb_dict, scalar=False) #Roi_head = RCNN , calls pre_loss_filtering from ROIHeadTemplate
