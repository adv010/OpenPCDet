...
def calc_mean_mAP():
    ...
    for _exp in exp_names:
        curr_eval_list_file = os.path.join("output/cfgs/kitti_models/pv_rcnn", _exp, "eval/eval_with_train/eval_list_val.txt")
        ...
        curr_res_dir = os.path.join("output/cfgs/kitti_models/pv_rcnn", _exp)
    ...
    if args.log_tb:
        ...
        new_exp_dir = os.path.join("output/cfgs/kitti_models/pv_rcnn", new_exp, "eval", "eval_with_train",
                                   "tensorboard_val")
