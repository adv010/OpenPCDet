...
def train_one_epoch(model, optimizer, train_loader, model_func, lr_scheduler, accumulated_iter, optim_cfg,
                    rank, tbar, total_it_each_epoch, dataloader_iter,cur_epoch,ckpt_save_dir, tb_log=None, leave_pbar=False, test_loader=None, dataloader_test_iter=None):
    ...
    for cur_it in range(total_it_each_epoch):
        ...
        # NOTE : zero_grad used below to zero out gradients when collecting static prototypes/features, remember to remove if training!!
        optimizer.zero_grad()
    ...
    with tqdm.trange(start_epoch, total_epochs, desc='epochs', dynamic_ncols=True, leave=(rank == 0)) as tbar:
        ...
        for cur_epoch in tbar:
            ...
            accumulated_iter = train_one_epoch(
                ...
                rank=rank, tbar=tbar, cur_epoch= cur_epoch, ckpt_save_dir = ckpt_save_dir, tb_log=tb_log,
